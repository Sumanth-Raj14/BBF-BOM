...
| RoHS/REACH compliance | ✅ Custom | ✅ Native | ✅ Native | ✅ Native | ✅ Native | ✅ Implemented — full substance-level model (concentrations, exemptions, SCIP/REACH obligations, staleness flags), dedicated UI (`PartComplianceTab`, `ComplianceReportPanel`); the strongest compliance area in the product | — (resolved, was MEDIUM) |
